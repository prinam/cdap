...
public final class Constants {
  ...
  public static final class HBase {
    ...
    public static final String MASTER_CLIENT_RETRIES = "master.hbase.client.retries.number";
    public static final String CLIENT_RETRIES = "hbase.client.retries.number";
    public static final String MASTER_RPC_TIMEOUT = "master.hbase.rpc.timeout";
